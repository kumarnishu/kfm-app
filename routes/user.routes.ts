...
router.route("/getall/users").get(isAuthenticatedUser, GetAllUsers)
    .post(isAuthenticatedUser, upload.single("media"), NewUser)
router.get("/dropdown/users", isAuthenticatedUser, GetUsersForDropdown)
router.route("/users/edit/:id")
    .put(isAuthenticatedUser, upload.single("media"), UpdateUser)
...
router.route("/profile")
    ...
    .put(isAuthenticatedUser, upload.single("media"), UpdateProfile)
