...
import { CreateSparePartFromExcel } from "../../services/SparePartServices"
...
export function SparePartExcelButton() {
    ...
    function HandleExport() {
        saveAs(`/api/v1/download/template/parts`)
    }
