...
import { ToogleBlockUser } from '../../../services/UserServices';
import { GetUserDto } from '../../../dtos/user.dto';
import { AlertContext } from '../../../contexts/alertContext';


function ToogleBlockDialog({ user }: { user: GetUserDto }) {
    ...
    return (
        <Dialog open={choice === UserChoiceActions.toogle_block_user ? true : false}
        ...
        >
            ...
            <DialogContent>
                <Typography variant="body1" color="error">
                    ...
                    {`Warning ! This will ${user.is_active ? `Block ` : 'Unblock '} this user`}
                </Typography>
            </DialogContent>
            <Stack
                direction="column"
...
export default ToogleBlockDialog
