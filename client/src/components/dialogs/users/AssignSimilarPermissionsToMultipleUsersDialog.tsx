...
import { AssignSimilarPermissionToMultipleUsers, GetPermissions } from '../../../services/UserServices';
import { IMenu, IPermission } from '../../../dtos/user.dto';
import { AlertContext } from '../../../contexts/alertContext';


function AssignSimilarPermissionsToMultipleUsersDialog({ user_ids }: { user_ids: string[] }) {
    ...
    const { mutate, isLoading, isSuccess, error } = useMutation
        ...
        (AssignSimilarPermissionToMultipleUsers, {
            onSuccess: () => {
...
export default AssignSimilarPermissionsToMultipleUsersDialog